...
namespace Biblioteca
{
    public class Subtracao
    {
        public void CalcularSubtracao()
        {
            ...
            Console.WriteLine("Por favor, digite o primeiro número a ser subtraido:");
            ...
            Console.WriteLine("Por favor, digite o segundo número a ser subtraido:");
            ...
            Console.WriteLine("O resultado da subtração de " + valor1 + " - " + valor2 + " é: " + (valor1 - valor2) + "\r\n");
